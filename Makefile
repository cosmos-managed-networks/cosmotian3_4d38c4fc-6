...
HTTPS_GIT := github.com/mygithub/cosmotian3.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=cosmotian3 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c cosmotian3 --local -f chains.yaml
endif
